...
HAL_StatusTypeDef HAL_SD_InitCard(SD_HandleTypeDef *hsd)
{
  ...
  /* Some cards on direct-wired sockets need extra power stabilization time
     after SDMMC power-up before CMD0/CMD8/ACMD41 negotiation starts. */
  HAL_Delay(20U);
