...
#ifndef USBD_WCID_SREAMING_H
#define USBD_WCID_SREAMING_H
...
#define  USB_DESC_TYPE_OS_FEATURE_EXT_COMPAT_ID       4   /* wIndex=4 -> CompatID (WINUSB) */
#define  USB_DESC_TYPE_OS_FEATURE_EXT_PROPERTIES      5   /* wIndex=5 -> Properties */
